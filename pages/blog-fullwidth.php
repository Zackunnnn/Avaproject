                        ...
                        <div class="wpo-blog-content">
                            <div class="post format-standard-image">
                                ...
                                <div class="entry-meta">
                                    <ul>
                                        <li><i class="fi flaticon-user"></i> By <a href="#">Achmad Varis</a> </li>
                            ...
                            <div class="post format-standard">
                                <div class="entry-meta">
                                    <ul>
                                        <li><i class="fi flaticon-user"></i> By <a href="#">Ava Design Team</a> </li>
                                        <li><i class="fi flaticon-comment-white-oval-bubble"></i> Comments 14 </li>
                                        <li><i class="fi flaticon-calendar-1"></i> 16 Januari 2025</li>
                                    </ul>
                                </div>
                                <div class="entry-details">
                            ...
                            <div class="post format-gallery">
                                ...
                                <div class="entry-meta">
                                    <ul>
                                        <li><i class="fi flaticon-user"></i> By <a href="#">Ava Team</a> </li>
                                        <li><i class="fi flaticon-comment-white-oval-bubble"></i> Comments 21 </li>
                                        <li><i class="fi flaticon-calendar-1"></i> 4 February 2024</li>
                                    </ul>
                                </div>
                                <div class="entry-details">
