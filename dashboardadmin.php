                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-2 col-md-6 col-6">
                                <div class="navbar-header">
                                    <a class="navbar-brand" href="dashboardadmin.php?p=index-2"><img src="assets/images/logo_white.png"
                                            alt="logo"></a>
                                </div>
                            </div>
                                ...
                                <div id="navbar" class="collapse navbar-collapse navigation-holder">
                                    ...
                                    <ul class="nav navbar-nav mb-2 mb-lg-0">
                                        <li class="menu-item-has-children">
                                            <a class="active" href="dashboardadmin.php?p=index-2" style="color: white">Home</a>
                                        </li>
                                        <li><a href="dashboardadmin.php?p=about">about us</a></li>
                                        <li class="menu-item-has-children">
                                            <a href="dashboardadmin.php?p=service-3">Services</a>
                                        </li>
                                        <li class="menu-item-has-children">
                                            <a href="dashboardadmin.php?p=property-2">Property</a>
                                        </li>
                                        <li class="menu-item-has-children">
                                            <a href="#">Pages</a>
                                            <ul class="sub-menu">
                                                <li><a href="dashboardadmin.php?p=about">About</a></li>
                                                <li><a href="dashboardadmin.php?p=shop">Shop</a></li>
                                                <li><a href="dashboardadmin.php?p=cart">Cart</a></li>
                                                <li><a href="dashboardadmin.php?p=checkout">Checkout</a></li>
                                                <li><a href="dashboardadmin.php?p=404">404 Error</a></li>
                                                <li><a href="dashboardadmin.php?p=faq">FAQ</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children">
                                            <a href="dashboardadmin.php?p=blog-fullwidth">Blog</a>
                                        </li>
                                        <li><a href="dashboardadmin.php?p=contact">Contact</a></li>
                                    ...
                                    <div class="widget instagram-widget">
                                        ...
                                        <div class="instagram-wrap">
                                            <div class="instagram-item">
                                                <a href="dashboardadmin.php?p=property-single">
